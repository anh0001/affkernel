...
def init_distributed():
    ...
    try:
        ...
        # ValueError: the env:// rendezvous vars (RANK/WORLD_SIZE/MASTER_ADDR) are
        # unset, i.e. this is a plain single-process run.
        # RuntimeError: the distributed backend or a CUDA device is unavailable.
